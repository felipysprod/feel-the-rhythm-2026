...
const translations = {
  EN: {
    ...
    "process.step1.desc": "We discuss your vision, style, and goals for the video.",
    "process.step2.title": "Editing",
    "process.step2.desc": "I craft the story, add sound design, and motion graphics.",
    "process.step3.title": "Review",
    "process.step3.desc": "You review the draft and we make any necessary adjustments.",
    "process.step4.title": "Delivery",
    "process.step4.desc": "The final high-quality video is delivered ready for upload.",
  ...
  PT: {
    ...
    "process.step1.title": "Briefing",
    "process.step1.desc": "Discutimos sua visão, estilo e objetivos para o vídeo.",
    "process.step2.title": "Edição",
    "process.step2.desc": "Eu crio a história, adiciono design de som e motion graphics.",
    "process.step3.title": "Revisão",
    "process.step3.desc": "Você revisa o rascunho e fazemos os ajustes necessários.",
    "process.step4.title": "Entrega",
    "process.step4.desc": "O vídeo final em alta qualidade é entregue pronto para postar.",
    "testimonials.tag": "Feedback",
