    ...
    <section id="shorts" className="py-32 px-6 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="text-5xl md:text-6xl font-black text-white uppercase mt-2">{t('shorts.title')}</h2>
        </div>
          ...
          {shorts.map((short, i) => (
            ...
            >
              <img 
                src={short.image} 
                alt="Short Thumbnail" 
                className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 ${short.id === 2 ? 'object-left' : ''}`}
              />
