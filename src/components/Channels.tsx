...
const channels = [
  { name: "Yuriilouco", subs: "871k subs", image: "https://api.dicebear.com/7.x/avataaars/svg?seed=yurii" },
  { name: "leleo", subs: "739k subs", image: "https://api.dicebear.com/7.x/avataaars/svg?seed=leleo" },
  { name: "Nicks", subs: "473k subs", image: "https://api.dicebear.com/7.x/avataaars/svg?seed=nicks" },
];
